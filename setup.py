...
setup(
    ...
    install_requires=[
        ...
        'anthill.gaming.apigw',
        'anthill.gaming.backup',
        'anthill.gaming.bot',
        'anthill.gaming.config',
        'anthill.gaming.discovery',
        'anthill.gaming.dlc',
        'anthill.gaming.environment',
        'anthill.gaming.event',
        'anthill.gaming.exec',
        'anthill.gaming.game_master',
        'anthill.gaming.game_controller',
        'anthill.gaming.leaderboard',
        'anthill.gaming.login',
        'anthill.gaming.market',
        'anthill.gaming.media',
        'anthill.gaming.message',
        'anthill.gaming.moderation',
        'anthill.gaming.blog',
        'anthill.gaming.profile',
        'anthill.gaming.promo',
        'anthill.gaming.report',
        'anthill.gaming.social',
        'anthill.gaming.store',
        'anthill.gaming.vote',
    ],
    extras_require={
